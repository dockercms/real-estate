...
public class UploadFileUtil {
    ...
    public void setDomainName(String domainName) {
        UploadFileUtil.domainName = domainName;
    }
    ...
    public static String uploadFile(MultipartFile file, String fileName) throws IOException {
        ...
        try {
            ...
            if (System.getProperty("os.name").toLowerCase().contains("windows")) {
                ...
                uploadPath = "/mnt/ztuo/pic/upload" + File.separator + directory;
            }
            ...
            fop.flush();
            fop.close();
            return domainName+"/pic" + File.separator + directory + File.separator + fileName;
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            fop.close();
    ...
    public static String uploadFiles(MultipartFile[] files) throws IOException {
        if (files != null && files.length > 0) {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                picUrl = uploadFile(file,fileName);
